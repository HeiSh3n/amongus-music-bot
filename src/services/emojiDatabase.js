...
// context7: Database adapter pattern for emoji management
...
switch (dbType) {
  ...
  //   break;
  default:
    throw new Error(`context7: Unsupported DB_TYPE '${dbType}'. Please provide a compatible adapter in src/services/emojiDatabase.${dbType}.js`);
}
